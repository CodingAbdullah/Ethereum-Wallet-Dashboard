...
export default function ERC721CollectionExtraDataInfoTable(props : { address: string }){
    const { address } = props;
    const {data, error, isLoading } = useSWR(['/api/erc721-collection-extra-data', { address }], ([url, body]) => PostFetcher(url, { arg: body }), { refreshInterval: 1000000000 });
    ...
    if (isLoading) {
        ...
        return (
            <div className="p-4 bg-gray-900 mt-10 shadow-lg">
                <h2 className="text-2xl font-bold mb-4 text-gray-100">ERC721 Collection Information</h2>
                <Table>
                    <TableHeader>
                        <TableRow>
