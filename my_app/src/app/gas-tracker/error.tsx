  ...
  return (
    <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="text-center">
        ...
        <h1 className="text-3xl font-bold text-gray-100 mb-4">Unable to Fetch Gas Data</h1>
        <p className="text-xl text-gray-400 mb-8">
          We're having trouble retrieving the latest Ethereum gas prices. This could be due to network issues or API limitations.
        </p>
