...
export default async function POST(request: Request){
    ...
    const data = await fetch(MORALIS_URL + body.address + '/nft/transfers?chain=' + body.network + '&format=decimal&direction=both', options) // Pass in address and chain values
