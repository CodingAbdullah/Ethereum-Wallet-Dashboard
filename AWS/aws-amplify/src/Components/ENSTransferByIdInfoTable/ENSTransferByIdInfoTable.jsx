...
const ENSTransferByIdInfoTable = (props) => {
    const { data } = props;
    ...
    return (
        <>
            <p><b>ENS Transfer Information</b><br /><i>History of all domain transfers for: </i><b>{ data.information.results[0].ens_name }</b></p>
...
export default ENSTransferByIdInfoTable;