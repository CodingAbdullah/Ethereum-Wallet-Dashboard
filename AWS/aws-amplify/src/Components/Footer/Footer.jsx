        ...
        return (            
            <div class="footer footer-container container">
                <footer class="footer col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    <div class="container">
                        <p style={{ marginTop: '-0.08rem' }} className="copyright-paragraph">
                            ...
                            <a style={{ color:'black' }} href="https://docs.opensea.io/reference/api-overview" target="_blank" rel="noreferrer"><img style={{ marginRight: '0.25rem'}} src={require("../../assets/images/opensea.png")} width="20" height="20" alt="logo" />Opensea</a>
                        ...
                        <p style={{ marginTop: '-0.75rem' }} className="copyright-paragraph">{ statement } <a style={{ color: 'black' }} href="https://reactjs.org/">React</a><img className="react-logo" src={require("../../assets/images/logo.svg").default} alt="logo" /></p>
                    </div>
                </footer>
            </div>
        )
