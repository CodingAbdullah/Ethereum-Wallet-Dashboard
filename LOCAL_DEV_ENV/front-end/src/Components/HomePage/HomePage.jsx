                        ...
                        <div class="container">                   
                            ...
                            <div class="row">
                                <div class="col-md-6 p-3">
                                    ...
                                    <br />
                                  { isFreeVersion ? null : <button class="btn btn-outline-primary wallet-search-button" onClick={ bitcoinButtonHandler }>View Price Action &raquo;</button> }
                                </div>
                                <div class="col-md-6 p-3">
                                    ...
                                    <br />
                                    { isFreeVersion ? null : <button class="btn btn-outline-primary wallet-search-button" onClick={ ethereumButtonHandler }>View Price Action &raquo;</button> }
                                </div>
                            </div>
                        </div>
                </main>
