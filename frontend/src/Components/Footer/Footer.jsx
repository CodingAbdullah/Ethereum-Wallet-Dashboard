    ...
    return (
            <div class="footer-container container">
                <footer class="footer col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    <div class="container">
                        <p style={{ marginLeft: '2rem', marginTop: '-0.08rem' }}className="copyright-paragraph" >Powered By:  
                            ...
                            <a style={{ color:'black' }} href="https://opensea.io/"><img style={{ marginRight: '0.15rem' }} src={require("../../assets/images/opensea.png")} width="25" height="25" alt="logo" />Opensea</a>
                        </p>
                        <p style={{ marginLeft: '2rem', marginTop: '-0.75rem' }} className="copyright-paragraph" >{statement} <a style={{ color: 'black' }} href="https://reactjs.org/">React</a><img className="react-logo" src={require("../../assets/images/logo.svg").default} alt="logo" /></p>
                    </div>
                </footer>
            </div>
    )
