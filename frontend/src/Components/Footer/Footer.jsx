                ...
                <footer class="footer col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    <div class="container">
                        <p style={{ marginLeft: '2.5rem', marginTop: '-0.08rem' }} className="copyright-paragraph">
                            <a style={{ color:'black' }} href="https://moralis.io/" target="_blank" rel="noreferrer"><img style={{ marginLeft: '0.25rem', marginRight: '0.15rem' }} src={require("../../assets/images/moralis.png")} width="25" height="25" alt="logo" />Moralis</a><span style={{ marginLeft: '0.25rem', marginRight: '0.25rem' }}><b>|</b></span>
                            ...
                            <a style={{ color:'black' }} href="https://transpose.io/" target="_blank" rel="noreferrer"><img style={{marginRight: '0.15rem'}} src={require("../../assets/images/transpose.png")} width="20" height="20" alt="logo" />Transpose</a><span style={{ marginLeft: '0.25rem', marginRight: '0.25rem' }}><b>|</b></span> 
                            ...
                            <a style={{ color:'black' }} href="https://docs.alchemy.com/reference/" target="_blank" rel="noreferrer"><img style={{ marginRight: '0.15rem' }} src={require("../../assets/images/alchemy.png")} width="25" height="25" alt="logo" />Alchemy</a>
                        </p>
