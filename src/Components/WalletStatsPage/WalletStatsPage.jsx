        ...
        <div className="wallet-stats">
            ...
            { 
                checkComplete ? 
                    <>
                        { 
                            emptyTransactionAlert && !setAlert ? <Alert type="warning" /> : ( transactions.information !== null ? <div><hr style={{ marginTop: '3rem' }} /><TransactionsInfoTable walletAddress={ setWalletAddress } networkFetch={ transactions.information.isMoralis } data={ transactions.information.result } /></div> : null ) 
                        }
                        { 
