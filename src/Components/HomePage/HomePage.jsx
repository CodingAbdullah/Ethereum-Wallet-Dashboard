...
const Home = () => {
    ...
    if (trendingCoinsQuery.isLoading || globalMarketDataQuery.isLoading) {
        return <div role="main">Loading...</div>
    }
    else if (trendingCoinsQuery.isError || globalMarketDataQuery.isError){
        return <div role="main">Error fetching data!</div>
    }
    else if (trendingCoinsQuery.isSuccess && globalMarketDataQuery.isSuccess){
