...
const MetricsNavbar = () => {
    ...
    if ( price.information === null || gasInfo.information === null ){
                    ...
                    <div>
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item"> 
                                <p style={{ paddingLeft: '1rem', display: 'inline', color: 'white', marginTop: '1rem'}}>ETH Price: <b>{ price.information == null ? "Loading" : "$" + price.information.usd.toFixed(2) }</b></p>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item">
                                ...
                                <p style={{ display: 'inline', color: 'white' }}><b>{ " " + gasInfo.information.maxPrice + " " }Gwei</b></p>
                            </li>
                        </ul>
                    </div>
                </div>
