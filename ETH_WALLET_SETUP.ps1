...
# ---> .\ETH_WALLET_PROJECT.ps1 <laptop name>
...
mkdir LOCAL_ETHEREUM_PROJECT_ENV

cd LOCAL_ETHEREUM_PROJECT_ENV
...
echo 'LOCAL_ETHEREUM_PROJECT_ENV project setup is complete!'